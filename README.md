# Hướng dẫn cập nhật module download từ 4.0.29, 4.1.00 lên 4.1.01

Chú ý: 
- Gói cập nhật này chỉ dành cho module download 4.0.29 và 4.1.00, nếu module của bạn không ở phiên bản này cần tìm các hướng dẫn cập nhật lên tối thiểu 4.0.29 trước.
- Module download 4.1.01 hoạt động tốt trên NukeViet 4 RC3, NukeViet 4 Official và NukeViet 4.1 Beta
...
Tải gói cập nhật tại https://github.com/nukeviet/module-download/releases/download/4.1.01/update-to-4.1.01.zip. Giải nén và upload thư mục install lên ngang hàng với thư mục install trên server. Đăng nhập quản trị site, nhận được thông báo cập nhật và tiến hành cập nhật theo hướng dẫn của hệ thống.
