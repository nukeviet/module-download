# Hướng dẫn cập nhật module download từ 4.0.29, 4.1.00, 4.1.01, 4.1.02, 4.2.00, 4.2.01, 4.2.02, 4.3.00, 4.5.00, 4.5.02, 4.5.03, 4.5.08 lên 4.6.00

Chú ý:
- Gói cập nhật này dành cho module download 4.0.29, 4.1.00, 4.1.01, 4.1.02, 4.2.00, 4.2.01, 4.2.02, 4.3.00, 4.5.00, 4.5.02, 4.5.03, 4.5.08 nếu module của bạn không ở phiên bản này cần tìm các hướng dẫn cập nhật lên tối thiểu 4.0.29 trước.
- Module download 4.6.00 hiện tại hoạt động trên NukeViet 4.6.00, 4.6.01
...
Tải gói cập nhật tại https://github.com/nukeviet/module-download/releases/download/4.6.00/update-to-4.6.00.zip. Giải nén và upload thư mục install lên ngang hàng với thư mục install trên server. Đăng nhập quản trị site, nhận được thông báo cập nhật và tiến hành cập nhật theo hướng dẫn của hệ thống.
